...
with desired(type_name, name, focus_area, equipment, default_metric, suggested_sets, suggested_reps, notes) as (
  values
    ('Cardio', 'Jog', 'Easy', null, 'distance_time', null, null, 'Easy pace; track distance, time, RPE/feel and notes.'),
    ('Cardio', 'Run', 'Run', null, 'distance_time', null, null, 'Track distance, time, RPE/feel and notes.'),
    ('Cardio', 'Bike', 'Bike', 'Bike / stationary bike', 'distance_time', null, null, 'Track distance or minutes, RPE/feel and notes.'),
    ('Cardio', 'Row', 'Row', 'Rower', 'distance_time', null, null, 'Track distance or minutes, RPE/feel and notes.'),
    ('Cardio', 'Sprint', 'Speed', null, 'distance_time', null, null, 'Track efforts, distance or time per effort, RPE/feel and notes.'),
    ('Skills/Calisthenics', 'Bar Muscle-Up', 'Pull', 'Bar / Bodyweight / Assistance / Added weight', 'reps_only', '3', '6-10', 'Track total reps across all sets, assistance or added load as needed.'),
    ('Skills/Calisthenics', 'Ring Muscle-Up', 'Pull', 'Rings / Bodyweight / Assistance / Added weight', 'reps_only', '3', '6-10', 'Track total reps across all sets, assistance or added load as needed.'),
    ('Skills/Calisthenics', 'Handstand Pushups', 'Push', 'Wall / parallettes / bodyweight', 'reps_only', '3', '6-10', 'Track total reps across all sets and assistance or deficit as needed.'),
    ('Skills/Calisthenics', 'Pistol Squat', 'Legs', 'Bodyweight / assistance / added load', 'reps_only', '3', '6-10', 'Track total reps across all sets and assistance or added load as needed.'),
    ('Skills/Calisthenics', 'Pushups', 'Push', 'Bodyweight / added load', 'reps_only', '3', '10-20', 'Track total reps across all sets and variation details in notes.'),
    ('Skills/Calisthenics', '1-Arm Pushups', 'Push', 'Bodyweight / assistance', 'reps_only', '3', '3-8', 'Track total reps across all sets and assistance or progression details in notes.'),
    ('Class', 'Yoga Class', 'Class', 'Mat', 'duration', null, null, 'Use notes for venue, instructor, class style and difficulty.'),
    ('Class', 'Pilates Class', 'Class', 'Mat', 'duration', null, null, 'Use notes for venue, instructor, class style and difficulty.'),
    ('Class', 'Strength Class', 'Class', 'Any', 'duration', null, null, 'Use notes for venue, instructor, class style and difficulty.'),
    ('Class', 'Conditioning Class', 'Class', 'Any', 'duration', null, null, 'Use notes for venue, instructor, class style and difficulty.'),
    ('Other', 'Other Session', 'Other', 'Any', 'duration', null, null, 'Catch-all only when no other movement fits.'),
    ('Mobility/Flexibility', 'Side Split', 'Flexibility', 'Mat', 'mobility_position', null, null, 'Track distance in cm, hold seconds and feel 1-5.'),
    ('Mobility/Flexibility', 'Pancake', 'Flexibility', 'Mat', 'mobility_position', null, null, 'Track distance in cm, hold seconds and feel 1-5.'),
    ('Mobility/Flexibility', 'Pike', 'Flexibility', 'Mat', 'mobility_position', null, null, 'Track distance in cm, hold seconds and feel 1-5.'),
    ('Mobility/Flexibility', 'Bridge', 'Flexibility', 'Mat', 'mobility_position', null, null, 'Track distance in cm, hold seconds and feel 1-5.'),
    ('Mobility/Flexibility', 'Shoulder Flexion', 'Flexibility', 'Wall / floor', 'mobility_position', null, null, 'Track distance in cm, hold seconds and feel 1-5.'),
    ('Climbing', 'Bouldering Session', 'Climbing', 'Climbing gym', 'climbing', null, null, 'Track minutes, boulders/problems, max grade, gradient where relevant, RPE and notes.'),
    ('Climbing', 'Ropes/Belay', 'Climbing', 'Climbing gym', 'climbing', null, null, 'Track minutes, routes, max grade, RPE and notes.'),
    ('Climbing', 'Kilter', 'Climbing', 'Kilter board', 'climbing', null, null, 'Track minutes, boulders/problems, max grade, gradient, RPE and notes.'),
    ('Climbing', 'Mix', 'Climbing', 'Climbing gym', 'climbing', null, null, 'Mixed climbing session; track the useful details in notes.')
),
typed as (
...
desired(name, focus_area, equipment, default_metric, suggested_sets, suggested_reps, notes) as (
  values
    ('Lat Pulldown', 'Pull', 'Cable machine', 'weight_reps', '3', '8-12', 'Track machine weight, reps and RPE.'),
    ('Chin-Up', 'Pull', 'Bodyweight / Assistance / Added weight', 'reps_only', '3', '6-10', 'Track bodyweight reps, assistance or added load as needed.')
),
numbered as (
  select
    desired.*,
