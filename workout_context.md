...
- Forty-nine rep-only historical totals were split into individual sets using the approved balanced non-increasing rule, preserving all 757 affected reps exactly. The remaining reviewed `Front Lever` record was corrected to 1/1/1. Thirteen duration-based aggregate rows remain.
